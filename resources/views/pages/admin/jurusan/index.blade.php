...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <div class="row">
                <div onclick="location.href='kompetisi';"class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1"></a>
                        <div class="card-icon bg-primary">
                        <i>
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="30" viewBox="0 5 70 69" fill="none">
                ...
                <div onclick="location.href='penghargaan'; "class="col-lg-3 col-md-6 col-sm-6 col-12">
